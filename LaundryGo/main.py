...
class LaundryApp:
    ...
    def build_slide1(self):
        ...
        # Tombol pergi ke slide 2
        self.btn_slide2 = tk.Button(
            self.slide1,
            text="Lihat Antrian →",
        ...
        self.btn_slide2.place(x=360, y=350)
